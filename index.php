...
<html lang="en" dir="ltr">
    ...
    <body class="html front not-logged-in no-sidebars page-node page-node- page-node-2 node-type-page c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse c-header-not-fixed " >
                            ...
                            <div id="block-md-slider-homepage" class="block block-md-slider">
                                ...
                                <div class="content">
                                    <div id="md-slider-1-block" class="md-slide-items" data-thumb-width='100' data-thumb-height='75'>
                                        ...
                                        <div class="md-slide-item slide-1" data-timeout='8000' data-transition="slit-horizontal-bottom-up" data-thumb-type='image' data-thumb-alt='' data-thumb='http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/md_slider_1_thumb/public/bg-43.jpg?itok=ELzMz2fw'>
                                            <div class="md-mainimg" style="">
                                                <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-43.jpg" alt="" />
                                            </div>
                                            <div class="md-objects">
                                                <div class="md-object md-layer-1-0-0 c-layout-revo-slider-4" data-x='11' data-y='0' data-width='1187' data-height='500' data-start='100' data-stop='7600' data-easein='bounceIn' data-easeout='fadeOut'>
                                                    <h3 class="c-main-title-circle c-font-48 c-font-bold c-font-center c-font-uppercase c-font-white c-block"> JANGO IS OPTIMIZED
                                                        <br>TO EVERY DEVELOPMENT </h3>              </div>
                                            </div>
                                        </div>

                                        <div class="md-slide-item slide-2" data-timeout='8000' data-transition="slit-vertical-down" data-thumb-type='image' data-thumb-alt='' data-thumb='http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/md_slider_1_thumb/public/bg-19.jpg?itok=UuhGRCGV'>
                                            <div class="md-mainimg" style="">
                                                <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-19.jpg" alt="" />
                                            </div>
                                            <div class="md-objects">
                                                <div class="md-object md-layer-1-1-0 c-layout-revo-slider-4" data-x='48' data-y='0' data-width='1152' data-height='500' data-start='200' data-stop='7700' data-easein='bounceIn' data-easeout='fadeOut'>
                                                    <h3 class="c-main-title-square c-font-55 c-font-bold c-font-center c-font-uppercase c-font-white c-block"> Let us show you
                                                        <br>Unlimited possibilities </h3>              </div>
                                            </div>
                                        </div>

                                        <div class="md-slide-item slide-3" data-timeout='8000' data-transition="slit-horizontal-top-right" data-thumb-type='image' data-thumb-alt='' data-thumb='http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/md_slider_1_thumb/public/bg-20.jpg?itok=U_eYs7a8'>
                                            <div class="md-mainimg" style="">
                                                <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-20.jpg" alt="" />
                                            </div>
                                            <div class="md-objects">
                                                <div class="md-object md-layer-1-2-0 c-layout-revo-slider-4" data-x='0' data-y='0' data-width='1200' data-height='500' data-start='300' data-stop='8000' data-easein='bounceIn' data-easeout='fadeOut'>
                                                    <h3 class="c-main-title-circle c-font-48 c-font-bold c-font-center c-font-uppercase c-font-white c-block"> JANGO IS OPTIMIZED
                                                        <br>TO EVERY DEVELOPMENT </h3>              </div>
                                                <div class="md-object md-layer-1-2-1" data-x='515' data-y='372' data-width='104' data-height='16' data-start='600' data-stop='8000' data-easein='fadeInUp' data-easeout='fadeOutDown' data-paddingtop='15' data-paddingright='15' data-paddingbottom='15' data-paddingleft='15'>
                                                    <a href="#" class="c-action-btn btn btn-lg c-btn-square c-theme-btn c-btn-bold c-btn-uppercase">Learn More</a>              </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="content">
                                            <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div  class = 'c-content-box c-size-md c-bg-white '>
                                                    <div  class = 'container '>
                                                        <div  class = 'row '>
                                                            <div  class = 'col-sm-4 '>
                                                                <div  class = 'c-content-feature-1 wow animate fadeInLeft ' data-wow-delay = '0.02s '><div class="c-content-line-icon c-theme c-icon-screen-chart"></div><h3 class="c-font-uppercase c-font-bold">Registrati</h3><div class="alt-features-descr align-left">
                                                            ...
                                                            <div  class = 'col-sm-4 '>
                                                                <div  class = 'c-content-feature-1 wow animate fadeInDown ' data-wow-delay = '0.12s '><div class="c-content-line-icon c-theme c-icon-support"></div><h3 class="c-font-uppercase c-font-bold">Prenota</h3><div class="alt-features-descr align-left">
                                                            ...
                                                            <div  class = 'col-sm-4 c-card '>
                                                                <div  class = 'c-content-feature-1 wow animate fadeInRight ' data-wow-delay = '0.24s '><div class="c-content-line-icon c-theme c-icon-bulb"></div><h3 class="c-font-uppercase c-font-bold">Calendario</h3><div class="alt-features-descr align-left">
                                                ...
                                                <div  class = 'c-bg-grey-1 ' style = 'padding-bottom: 80px; padding-top: 80px; '>
                                                    <div  class = 'container '>
                                                        <div  class = 'row '>
                                                                ...
                                                                <div class="c-content-feature-5">
                                                                    <div class="c-content-feature-5">
                                                                        <div class="c-content-title-1" style="width: 175px;">
                                                                            <h3 class="c-left c-font-dark c-font-uppercase c-font-bold">PERCHE' SCEGLIERCI</h3>
                                                                            <div class="c-line-left c-bg-blue-3"></div>
                                                                        </div>
                                                                        <div class="c-text c-font-16 c-font-sbold c-font-uppercase"> 
                                                                            <p>LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT, SED DO EIUSMOD.</p>
                                                                        </div>
                                                                        <a href="#" class="btn c-btn-uppercase btn-md c-btn-sbold c-btn-square c-theme-btn">Purchase</a>
                                                                        <img class="c-photo img-responsive" style="width: 60%" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/jango-intro-2.jpg" alt="" /> </div>
                                                                </div>
                                                            </div>
                                                            <div  class = 'col-md-5 wow animate fadeInRight '>
                                                                <div class="c-content-accordion-1 c-theme"><div class="panel-group" id = "accordion-1" role = "tablist" >
                                                                        <div class="panel">
                                                                            <div class="panel-heading" role="tab" id="accordiontab">
                                                                                <h4 class="panel-title">
                                                                                    <a class="c-font-bold c-font-19 " data-toggle="collapse" data-parent="#accordion-1" href="#4983768" aria-expanded="true" aria-controls="4983768"><i class=""></i>CUSTOMISIBLE CAMPAIGN AVAILABLE</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div id="4983768" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="accordiontab" aria-expanded="true" style="">
                                                                        ...
                                                                        <div class="panel">
                                                                            <div class="panel-heading" role="tab" id="accordiontab">
                                                                                <h4 class="panel-title">
                                                                                    <a class="c-font-bold c-font-19 collapsed" data-toggle="collapse" data-parent="#accordion-1" href="#9462294" aria-expanded="false" aria-controls="9462294"><i class=""></i>DEDICATED SUPPORT FOR YOUR STAFF</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div id="9462294" class="panel-collapse collapse " role="tabpanel" aria-labelledby="accordiontab" aria-expanded="false" style="height: 0px;">
                                                                                <div class="panel-body c-font-18">
                                                                                    <p><span style="color:#FFFFFF;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco. </span></p>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel">
                                                                            <div class="panel-heading" role="tab" id="accordiontab">
                                                                                <h4 class="panel-title">
                                                                                    <a class="c-font-bold c-font-19 collapsed" data-toggle="collapse" data-parent="#accordion-1" href="#6720574" aria-expanded="false" aria-controls="6720574"><i class=""></i>AWESOME FEATURES FOR EVERYONE</a>
                                                                                </h4>
                                                                            </div>
                                                                            <div id="6720574" class="panel-collapse collapse " role="tabpanel" aria-labelledby="accordiontab" aria-expanded="false" style="height: 0px;">
                                                                                <div class="panel-body c-font-18">
                                                                                    <p><span style="color:#FFFFFF;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco. </span></p>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div  class = 'c-content-box c-size-md c-bg-white '>
                                                    <div  class = 'c-content-tile-grid c-bs-grid-reset-space ' data-auto-height = 'true ' style = ' text-align:right;'>
                                                        ...
                                                        <div  class = 'row wow animate fadeInUp '>      <div class = "c-content-tile-grid c-bs-grid-reset-space">
                                                                <div class="col-md-6">
                                                                                ...
                                                                                <div class="c-tile-content c-content-v-center" data-height="height">
                                                                                    <div class="c-wrapper">
                                                                                        <div class="c-body c-center">
                                                                                            ...
                                                                                            <a href="http://jango.nikadevs.com/content/nothing-impossible-jango-highly-flexible-always-growing" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">More</a>            </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-arrow-right c-arrow-green c-content-overlay">
                                                                                    <div class="c-overlay-wrapper">
                                                                                        <div class="c-overlay-content">
                                                                                            <a href="/content/nothing-impossible-jango-highly-flexible-always-growing">
                                                                                                <i class="icon-link"></i>
                                                                                            </a>
                                                                                            <a href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/79.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
                                                                                                <i class="icon-magnifier"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="c-image c-overlay-object" data-height="height" style="background-image: url(http://jango.nikadevs.com/sites/jango.nikadevs.com/files/79.jpg)"></div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="c-tile-content c-content-v-center" data-height="height">
                                                                                    <div class="c-wrapper">
                                                                                        <div class="c-body c-center">
                                                                                            ...
                                                                                            <p class="c-tile-body c-font-white">Lorem ipsum consectetuer elit sit amet, sit adipiscing amet, coectetuer adipiscing elit sit ame.

                                                                                            </p>
                                                                                            <a href="http://jango.nikadevs.com/content/web-design" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">More</a>            </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-arrow-right c-arrow-brown-2 c-content-overlay">
                                                                                    <div class="c-overlay-wrapper">
                                                                                        <div class="c-overlay-content">
                                                                                            <a href="/content/web-design">
                                                                                                <i class="icon-link"></i>
                                                                                            </a>
                                                                                            <a href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/90.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
                                                                                                <i class="icon-magnifier"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="c-image c-overlay-object" data-height="height" style="background-image: url(http://jango.nikadevs.com/sites/jango.nikadevs.com/files/90.jpg)"></div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-arrow-left c-arrow-red-2 c-content-overlay">
                                                                                    <div class="c-overlay-wrapper">
                                                                                        <div class="c-overlay-content">
                                                                                            <a href="/content/learn-more-about-jango">
                                                                                                <i class="icon-link"></i>
                                                                                            </a>
                                                                                            <a href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/41.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
                                                                                                <i class="icon-magnifier"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="c-image c-overlay-object" data-height="height" style="background-image: url(http://jango.nikadevs.com/sites/jango.nikadevs.com/files/41.jpg)"></div>
                                                                                </div>
                                                                            </div>  
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-content-v-center" data-height="height">
                                                                                    <div class="c-wrapper">
                                                                                        <div class="c-body c-center">
                                                                                            ...
                                                                                            <p class="c-tile-body c-font-white"></p>
                                                                                            <a href="http://jango.nikadevs.com/content/learn-more-about-jango" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">More</a>            </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-arrow-left c-arrow-blue-3 c-content-overlay">
                                                                                    <div class="c-overlay-wrapper">
                                                                                        <div class="c-overlay-content">
                                                                                            <a href="/content/future">
                                                                                                <i class="icon-link"></i>
                                                                                            </a>
                                                                                            <a href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/78.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
                                                                                                <i class="icon-magnifier"></i>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="c-image c-overlay-object" data-height="height" style="background-image: url(http://jango.nikadevs.com/sites/jango.nikadevs.com/files/78.jpg)"></div>
                                                                                </div>
                                                                            </div>  
                                                                            <div class="col-sm-6">
                                                                                <div class="c-tile-content c-content-v-center" data-height="height">
                                                                                    <div class="c-wrapper">
                                                                                        <div class="c-body c-center">
                                                                                            ...
                                                                                            <p class="c-tile-body c-font-white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, nonummy nibh euismod tincidunt.

                                                                                            </p>
                                                                                            <a href="http://jango.nikadevs.com/content/future" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">More</a>            </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div  style = 'background-image: url("http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-82.jpg"); padding-bottom: 60px; padding-top: 60px; '>
                                                    <div  class = 'container '>
                                                        ...
                                                        <div ><div class="view view-project view-id-project view-display-id-page_3 view-dom-id-5929290a8a7f63041665e2e24af48646">
                                                                    ...
                                                                    <div class="c-content-isotope-gallery c-opt-1 cols-4">
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/16.jpg?itok=FmqyX2sS" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/16.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/16.jpg'" data-caption="<h4>Seemple Music for iPad</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn  c-item-size-double" data-wow-delay="0.1s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/1.jpg?itok=eGUb8qQQ" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/1.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/1.jpg'" data-caption="<h4>Ski Buddy</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="0.2s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/4.jpg?itok=N4qb-Nc0" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/4.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/4.jpg'" data-caption="<h4>John Doe</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="0.3s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/7.jpg?itok=x0PtNy63" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/7.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/7.jpg'" data-caption="<h4>WhereTO App</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="0.4s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/10.jpg?itok=mlLwkcQZ" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/10.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/10.jpg'" data-caption="<h4>To-Do Dashboard</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="0.5s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/13.jpg?itok=LM4TNOkH" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/13.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/13.jpg'" data-caption="<h4>World Clock Widget</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="c-content-isotope-item wow animate zoomIn " data-wow-delay="0.6s">
                                                                            <div class="c-content-isotope-image-container">
                                                                                <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__600x600_/public/17.jpg?itok=iNzJIOJz" width="600" height="600" alt="Alt" />        <div class="c-content-isotope-overlay c-ilightbox-image-1" href="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/17.jpg" data-options="thumbnail:'http://jango.nikadevs.com/sites/jango.nikadevs.com/files/17.jpg'" data-caption="<h4>Dashboard 123</h4><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>">
                                                                                    <div class="c-content-isotope-overlay-icon">
                                                                                        <i class="fa fa-plus c-font-white"></i>
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div  style = 'padding-top: 80px; '>
                                                    <div  class="c-content-title-1"><h3 class="c-center c-font-uppercase   c-font-bold  "><span class = "title-wrap">ELENCO ESAMI</span></h3><div class ="c-line-center c-theme-bg c-bg-green c-bg-after-green"></div></div>
                                                    <div class="c-content-tab-2 c-theme c-opt-1">
                                                        <ul class="nav c-tab-icon-stack c-font-sbold c-font-uppercase">

                                                            <li class="active">
                                                                <a href="#c-tab2-opt1-70203" data-toggle="tab">
                                                            ...
                                                            <li >
                                                                <a href="#c-tab2-opt1-35596" data-toggle="tab">
                                                            ...
                                                            <li >
                                                                <a href="#c-tab2-opt1-46200" data-toggle="tab">
                                                            ...
                                                            <li >
                                                                <a href="#c-tab2-opt1-41774" data-toggle="tab">
                                                            ...
                                                            <li >
                                                                <a href="#c-tab2-opt1-99512" data-toggle="tab">
                                                                    <span class="c-content-line-icon c-icon-33"></span>
                                                                    <span class="c-title">Vue</span>
                                                                </a>
                                                                <div class="c-arrow"></div>
                                                            </li>
                                                        ...
                                                        <div class="c-bg-img-center1" style="background-image: url(http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-62_0.jpg)">
                                                            <div class="container">
                                                                <div class="tab-content"><div class="tab-pane fade in active" id="c-tab2-opt1-70203">
                                                                        <div class="c-tab-pane">
                                                                            <div  class = 'row ' style = 'padding-bottom: 40px; padding-top: 40px; '>
                                                                                <div  class = 'col-md-7 ' style = 'padding-bottom: 40px; padding-top: 40px; '>
                                                                                ...
                                                                                <div  class = 'col-md-5 ' style = 'padding-bottom: 40px; padding-top: 40px; '>
                                                                                    <span  style = 'float: right; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px;width: 420px; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px; '><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/19.jpg" alt="Alt" title="" /></span>
                                                                                </div>
                                                                            </div>

                                                                        </div>
                                                                    </div><div class="tab-pane fade " id="c-tab2-opt1-35596">
                                                                        <div class="c-tab-pane">
                                                                            <div  class = 'row ' style = 'padding-bottom: 80px; padding-top: 80px; '>
                                                                                ...
                                                                                <div  class = 'col-md-5 '>
                                                                                    <span  style = 'float: right; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px;width: 420px; '><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/11.jpg" alt="Alt" title="" /></span>
                                                                                </div>
                                                                            </div>

                                                                        </div>
                                                                    </div><div class="tab-pane fade " id="c-tab2-opt1-46200">
                                                                        <div class="c-tab-pane">
                                                                            <div  class = 'row ' style = 'padding-bottom: 80px; padding-top: 80px; '>
                                                                                <div  class = 'col-md-7 '>
                                                                                ...
                                                                                <div  class = 'col-md-5 '>
                                                                                    <span  style = 'float: right; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px;width: 420px; '><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-20_0.jpg" alt="Alt" title="" /></span>
                                                                                </div>
                                                                            </div>

                                                                        </div>
                                                                    </div><div class="tab-pane fade " id="c-tab2-opt1-41774">
                                                                        <div class="c-tab-pane">
                                                                            <div  class = 'row ' style = 'padding-bottom: 80px; padding-top: 80px; '>
                                                                                <div  class = 'col-md-7 '>
                                                                                ...
                                                                                <div  class = 'col-md-5 '>
                                                                                    <span  style = 'float: right; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px; width: 420px; '><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-11.jpg" alt="Alt" title="" /></span>
                                                                                </div>
                                                                            </div>

                                                                        </div>
                                                                    </div><div class="tab-pane fade " id="c-tab2-opt1-99512">
                                                                        <div class="c-tab-pane">
                                                                            <div  class = 'row ' style = 'padding-bottom: 80px; padding-top: 80px; '>
                                                                                <div  class = 'col-md-7 '>
                                                                                ...
                                                                                <div  class = 'col-md-5 '>
                                                                                    <span  style = 'float: right; border-style: solid; border-width: 1px; padding-bottom: 5px; padding-top: 5px; padding-right: 5px; padding-left: 5px; width: 420px; '><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/65_0.jpg" alt="Alt" title="" /></span>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div  class = 'c-content-box c-size-lg c-bg-parallax ' style = 'background-image: url("http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-51_1.jpg"); '>
                                                    <div  class = 'container '>
                                                        <div class="c-content-feature-8 c-opt-1">
                                                            ...
                                                            <ul class="c-grid">
                                                                ...
                                                                <li>
                                                                    <div  style = 'height: 304px; background-image: url("http://jango.nikadevs.com/sites/jango.nikadevs.com/files/6.jpg"); ' class="c-card c-img c-bg-img-center">
                                                ...
                                                <div  class = 'c-content-box c-size-lg c-bg-parallax ' style = 'background-image: url("http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-87.jpg"); '>
                                                    <div  class = 'container '>
                                                ...
                                                <div  class = 'c-content-box c-size-lg c-bg-parallax ' style = 'background-image: url("http://jango.nikadevs.com/sites/jango.nikadevs.com/files/bg-13.jpg"); '>
                                                ...
                                                <div  class = 'c-bg-grey-1 ' style = 'padding-bottom: 60px; padding-top: 60px; '>
                                                    <div  class = 'container '>
                                                        ...
                                                        <div  style = 'margin-top: 40px; ' class="c-content-blog-post-card-1-slider" data-slider="owl" data-items="3" data-auto-play="8000">
                                                            <div class="owl-carousel owl-theme c-theme">
                                                                <div class="item">
                                                                    <div class="c-content-testimonial-3 c-option-default">
                                                                        ...
                                                                        <div class="c-person">
                                                                            <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__80x80_/public/team11.jpg?itok=PWqGA05t" width="80" height="80" alt="Alt" title="" />
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-testimonial-3 c-option-default">
                                                                        ...
                                                                        <div class="c-person">
                                                                            <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__80x80_/public/team10.jpg?itok=6HTXRlzS" width="80" height="80" alt="Alt" title="" />
                                                                            <div class="c-person-detail c-font-uppercase">
                                                                                <h4 class="c-name">Ashley Benson</h4>
                                                                                <p class="c-position c-font-bold c-theme-font">CFO, Loop Inc</p>
                                                                            </div>
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-testimonial-3 c-option-default">
                                                                        ...
                                                                        <div class="c-person">
                                                                            <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__80x80_/public/team14.jpg?itok=6rR0LFqr" width="80" height="80" alt="Alt" title="" />
                                                                            <div class="c-person-detail c-font-uppercase">
                                                                                <h4 class="c-name">Ashley Benson</h4>
                                                                                <p class="c-position c-font-bold c-theme-font">CFO, Loop Inc</p>
                                                                            </div>
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-testimonial-3 c-option-default">
                                                                        ...
                                                                        <div class="c-person">
                                                                            <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__80x80_/public/team12.jpg?itok=NJ9P-bTX" width="80" height="80" alt="Alt" title="" />
                                                                            <div class="c-person-detail c-font-uppercase">
                                                                                <h4 class="c-name">Ashley Benson</h4>
                                                                                <p class="c-position c-font-bold c-theme-font">CFO, Loop Inc</p>
                                                                            </div>
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-testimonial-3 c-option-default">
                                                                        ...
                                                                        <div class="c-person">
                                                                            <img class="img-responsive img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/styles/project__80x80_/public/team9.jpg?itok=SC1lAuj5" width="80" height="80" alt="Alt" title="" />
                                                                            <div class="c-person-detail c-font-uppercase">
                                                ...
                                                <div  class = 'container '>
                                                    ...
                                                    <div  class = 'row '>
                                                        <div  class = 'col-md-4 '>
                                                            <div >
                                                                <span ><img style="" class="img-responsive" src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/jango-intro-3.png" alt="Alt" title="" /></span>
                                                            </div>
                                                        </div>
                                                        <div  class = 'col-md-8 '>
                                                            <div  class = 'row '>
                                                                ...
                                                                <div  class = 'col-md-12 '>
                                                                    <div  style = ' text-align:center;'>
                                                                        <a  class = 'btn btn-md c-btn-dark c-btn-square c-btn-uppercase c-btn-bold c-btn-border-2x ' style = 'margin-left: -25px; margin-top: 30px;  text-align:center;' href="#" >Learn More</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-blog-post-card-1 c-option-2">
                                                                        <div class="c-media c-content-overlay">
                                                                            ...
                                                                            <img class="c-overlay-object img-responsive" src="img/01.jpg" alt=""> </div>
                                                                        <div class="c-body">
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-blog-post-card-1 c-option-2">
                                                                        <div class="c-media c-content-overlay">
                                                                            ...
                                                                            <img class="c-overlay-object img-responsive" src="img/03.jpg" alt=""> </div>
                                                                        <div class="c-body">
                                                                            <div class="c-title c-font-uppercase c-font-bold">
                                                                ...
                                                                <div class="item">
                                                                    <div class="c-content-blog-post-card-1 c-option-2">
                                                                        <div class="c-media c-content-overlay">
                                                                            ...
                                                                            <img class="c-overlay-object img-responsive" src="img/06.jpg" alt=""> </div>
                                                                        <div class="c-body">
                                                                            <div class="c-title c-font-uppercase c-font-bold">
                                                ...
                                                <div  style = 'padding-bottom: 60px; '>
                                                    <div  class = 'container '>
                                                        ...
                                                        <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl" data-items="5" data-desktop-items="4" data-desktop-small-items="3" data-tablet-items="3" data-mobile-small-items="2" data-auto-play="5000">
                                                            <div class="owl-carousel owl-theme c-theme owl-bordered1"><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client1.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client2.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client3.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client4.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client5.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client6.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client1_0.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client2_0.jpg" alt="" />
                                                                    </a>
                                                                </div><div class="item">
                                                                    <a href="#">
                                                                        <img src="http://jango.nikadevs.com/sites/jango.nikadevs.com/files/client3_0.jpg" alt="" />
                                                                    </a>
                                                                </div></div></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div  class = 'container '>
                                            <div  class = 'c-prefooter c-bg-white '>
                                                <div  class = 'c-body '>
                                                    <div  class = 'row '>
                                                        <div  class = 'col-xs-12 col-sm-6 col-md-4 '>
                                                            <ul class = "c-links c-theme-ul">	<li><a href="#">About Jango</a></li>	<li><a href="#">Privacy Policy</a></li>	<li><a href="#">Terms &amp; Conditions</a></li>	<li><a href="#">Delivery</a></li>	<li><a href="#">Promotions</a></li>	<li><a href="#">News</a></li></ul><ul class = "c-links c-theme-ul">	<li><a href="#">Blogs</a></li>	<li><a href="#">Projects</a></li>	<li><a href="#">Clients</a></li>	<li><a href="#">Services</a></li>	<li><a href="#">Features</a></li>	<li><a href="#">Stats</a></li></ul>
                                                        </div>
                                                        <div  class = 'col-xs-12 col-sm-6 col-md-5 '>
                                                            <div  class="c-content-title-1"><h3 class="c-left c-font-uppercase   c-font-bold c-font-20"><span class = "title-wrap">Latest Tweets</span></h3></div>
                                                            <div  class = 'c-twitter '>


                                                                <a class="twitter-timeline" href="//twitter.com/themehats"  data-widget-id="626329365547061249" data-tweet-limit="2" data-chrome="noheader nofooter noscrollbar noborders transparent">Loading tweets...</a>
                                                            </div>
                                                        </div>
                                                        <div  class = 'col-xs-12 col-sm-12 col-md-3 '>
                                                            ...
                                                            <p class="c-address c-font-16">25, Lorem Lis Street, Orange<br>California, US<br>Phone: 800 123 3456<br>Fax: 800 123 3456<br>Email: <a href="mailto:info@jango.com"> <span class="c-theme-color">info@jango.com</span> </a><br>Skype: <a href="#"> <span class="c-theme-color">jango</span> </a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div  class = 'c-line '>
                                                ...
                                                <div  class = 'c-foot '>
                                                    <div  class = 'row '>
                                                        <div  class = 'col-md-7 '>
                                                            <div  class="c-content-title-1"><h3 class="c-left c-font-uppercase   c-font-bold c-font-20"><span class = "title-wrap">About Jan <span class='c-theme-font'>GO</span></span></h3></div>
                                                            <div  class = 'c-text c-font-16 c-font-regular '><p>Tolerare unus ducunt ad brevis buxum. Est alter buxum, cesaris. Eheu, lura! Racanas crescere in emeritis oenipons! Ubi est rusticus repressor? Lixa grandis clabulare est. Eposs tolerare, tanquam fatalis.</p></div>
                                                        </div>
                                                        <div  class = 'col-md-5 '>
                                                ...
                                                <div  class = 'c-head '>
                                                    <div  class = 'row '>
                                                        <div  class = 'col-sm-12 col-md-6 '>
                                                            <div  class = 'c-left '>
                                                                <div  class = 'socicon '>
                                                                    <a href=" facebook" class = "socicon-btn socicon-btn-circle socicon-lg socicon-facebook tooltips" data-original-title=""></a>
                                                                    <a href=" facebook" class = "socicon-btn socicon-btn-circle socicon-facebook tooltips" data-original-title=""></a>
                                                                    <a href=" youtube" class = "socicon-btn socicon-btn-circle socicon-youtube tooltips" data-original-title=""></a>
                                                                    <a href=" twitter" class = "socicon-btn socicon-btn-circle socicon-twitter tooltips" data-original-title=""></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div  class = 'col-sm-12 col-md-6 '>
                                                            <div  class = 'c-right '>
                                                                <div  class="c-content-title-1"><h3 class="c-left c-font-uppercase   c-font-bold c-font-20"><span class = "title-wrap">Download Mobile App</span></h3></div>
                                                                <div  class = 'c-icons '>
                                                                    <a href=" android" class = "socicon-btn socicon-lg socicon-android tooltips" data-original-title=""></a>
                                                                    <a href=" apple" class = "socicon-btn socicon-lg socicon-apple tooltips" data-original-title=""></a>
                                                                    <a href=" windows" class = "socicon-btn socicon-lg socicon-windows tooltips" data-original-title=""></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript" src="http://jango.nikadevs.com/sites/all/modules/md_slider/js/jquery.touchwipe.js?oh0l2u"></script>
        <script type="text/javascript" src="http://jango.nikadevs.com/sites/all/modules/md_slider/js/modernizr.js?oh0l2u"></script>
        <script type="text/javascript" src="http://jango.nikadevs.com/sites/all/modules/md_slider/js/jquery-migrate-1.2.1.min.js?oh0l2u"></script>
        <script type="text/javascript" src="http://jango.nikadevs.com/sites/all/modules/md_slider/js/jquery.easing.js?oh0l2u"></script>
        <script type="text/javascript" src="http://jango.nikadevs.com/sites/all/modules/md_slider/js/md-slider.js?oh0l2u"></script>
        <script type="text/javascript">
            ...
            (function ($) {
                $(document).ready(function () {
                    ...
                    $('#md-slider-1-block').mdSlider(options_1);
                });
            })(jQuery);
            //--><!]]>
        </script>
