		...
		<div class="container">
			<div class="c-content-feature-2-grid" data-auto-height="true" data-mode="base-height">
				<div class="c-content-title-1">
					<h3 class="c-font-uppercase c-center c-font-bold">CALENDARIO ESAMI</h3>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="c-content-feature-2" data-height="height">
							...
							<h3 class="c-font-uppercase c-font-bold c-title">Ecdl</h3>
							<p>
					...
					<div class="col-md-4 col-sm-6">
						<div class="c-content-feature-2" data-height="height">
							...
							<h3 class="c-font-uppercase c-font-bold c-title">Mos</h3>
							<p>
								Lorem ipsum consectetuer dolore elit diam
							</p>
						</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="c-content-feature-2" data-height="height">
							...
							<h3 class="c-font-uppercase c-font-bold c-title">Adobe</h3>
							<p>
								Lorem ipsum consectetuer dolore elit diam
							</p>
						</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="c-content-feature-2" data-wow-delay1="2s" data-height="height">
							...
							<h3 class="c-font-uppercase c-font-bold c-title">Pearson vue</h3>
							<p>
								Lorem ipsum consectetuer dolore elit diam
							</p>
						</div>
						...
						<div class="c-content-v-center c-theme-bg wow bounceInUp" data-wow-delay1="2s" data-height="height">
							<div class="c-wrapper">
								<div class="c-body c-padding-20 c-center">
									...
									Providing the best possible service to our customers without a breaking a sweat </h3>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="c-content-feature-2" data-wow-delay1="2s" data-height="height">
							...
							<h3 class="c-font-uppercase c-font-bold c-title">Trinity</h3>
							<p>
								Lorem ipsum consectetuer dolore elit diam
							</p>
						</div>
