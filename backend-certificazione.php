                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>Elenco Certificazioni
                                <small>consultazione certificazioni e modifica</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                    </div>
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Elenco Certificazioni</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                    <!-- BEGIN PAGE BASE CONTENT -->
                    <div class="note note-info">
                        <p> In questa pagina è possibile visualizzare le certificazioni, cercarle e modificarle. </p>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Elenco Certificazioni</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline collapsed" width="100%" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 100%;">
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" style="width: 39px;" aria-label="Organizzazione: activate to sort column ascending">
                                                            Organizzazione
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($listaCertificazioni as $certificazione) {
                                                        ...
                                                        $c = new Organizzazione($certificazione->getId_organizzazione());
                                                        $c->setId($certificazione->getId_organizzazione());
                                                        $c->select();
                                                        $organizzazioneNome = $c->getNome();
                                                        echo "<tr role='row' class='" . (($id % 2 == 0) ? 'even' : 'odd') . "'>";
                                                        echo "<td align='center' tabindex='0' class='sorting_1'><img style='height:50px;' src='img/certificazione/" . 
                                                                $certificazione->getLogo() . "' /></td>";
                                                        echo "<td>" . $certificazione->getNome() . "</td>";
                                                        echo "<td>" . $certificazione->getDescrizione() . "</td>";
                                                        echo "<td>" . $organizzazioneNome . "</td>";
                                                        echo "<td>
                                                                <div class='btn-group pull-right'>
                                                                    ...
                                                                    <ul class='dropdown-menu pull-right'>
                                                                            <li>
                                                                                    <a href='backend-certificazione-form.php?action=update&id=$id'>
                                                                                            <i class='fa fa-info'></i> Visualizza </a>
                                                                            </li>
                                                                            <li>
                                                                                    <a href='backend-certificazione-action.php?action=delete&id=$id' onclick='return confirm(\'Sei sicuro?\');'>
